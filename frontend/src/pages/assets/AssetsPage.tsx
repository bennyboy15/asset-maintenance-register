        ...
        <div className="p-6 max-w-7xl mx-auto">
            ...
            <div className="flex justify-between items-end mb-8">
                ...
                <div className="flex gap-4 items-center">
                    <button
                        onClick={() => setViewMine(!viewMine)}
                        className={`px-4 py-2 rounded-md transition ${viewMine ? 'bg-blue-100 text-blue-700 border-blue-200 border' : 'bg-slate-100 text-slate-600'}`}
                    >
                        {viewMine ? "Showing My Assets" : "Show All Assets"}
                    </button>
                    <Link
                        to="/assets/new"
